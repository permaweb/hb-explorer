...
export const ASSETS = {
	...
	aoEvents: getTxEndpoint('wc7BYgNEOCEKsMNswtuNHGHOHJV7oY9OeHF8c6fFHew'),
	...
	systemStats: getTxEndpoint('ugaEWgWbbjc8tinRvDX2vzMZTwjbD3DguZITMpmH-jE'),
	table: getTxEndpoint('04kZgVN9Cg2njpwIDvxiiFFYTMLjxD1tY7Df_Nv0U4w'),
	telegram: getTxEndpoint('uerxx9yd8y3DGRIJ4F9TjF4BryagPuINo5-Jo8qmno4'),
	telemetry: getTxEndpoint('vZO3zJfje3NOHq0gjlIziSg3NMJapoEUM5CZyDriOic'),
	...
	vmStats: getTxEndpoint('1B2fOGc817gkTX0vJsH8kROlv8CeP8iDE2B1d7cDErU'),
